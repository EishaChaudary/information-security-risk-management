...
ISO/IEC 27001
Probability–impact risk assessment matrix
Business Impact Analysis (BIA)
Risk treatment lifecycle (avoidance, mitigation, transfer, acceptance)
Key Outputs
Risk register and assessment findings
Evaluation of existing controls
Proposed mitigation strategies aligned with ISO 27001
Risk communication and treatment plan
